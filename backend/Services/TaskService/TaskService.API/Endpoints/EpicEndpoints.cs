...
public static class EpicEndpoints
{
    public static void MapEpicEndpoints(this IEndpointRouteBuilder routes)
    {
        ...
        // Get epic by ID
        group.MapGet("/{id}", async (Guid id, IEpicRepository repository) =>
        {
        ...
        group.MapGet("/project/{projectId}", async (Guid projectId, IEpicRepository repository) =>
        {
        ...
        // Create new epic
        group.MapPost("/", async (Epic epic, IEpicRepository repository) =>
        {
        ...
        // Update epic
        group.MapPut("/{id}", async (Guid id, Epic epic, IEpicRepository repository) =>
        {
            if (id != epic.Id)
        ...
        // Delete epic
        group.MapDelete("/{id}", async (Guid id, IEpicRepository repository) =>
        {
